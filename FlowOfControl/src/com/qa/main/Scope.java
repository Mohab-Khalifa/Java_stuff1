...
public class Scope {
	...
	public static void bigH4ck3r() {
		System.out.println(bankNumber); //wont work
	}
	
	// Local variables - Assurance that you're not going to use data somewhere you should'nt
	// disadvantage - having to re-write code sometimes
}
